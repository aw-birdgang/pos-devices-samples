...
import '../timeline/indicator_theme.dart';
        ...
        builder: TimelineTileBuilder.connected(
          indicatorBuilder: (context, index) {
            ...
            return OutlinedDotIndicator(
              color:
                  status.isInProgress ? const Color(0xff6ad192) : const Color(0xffe6e7e9),
              backgroundColor:
                  status.isInProgress ? const Color(0xffd4f5d6) : const Color(0xffc2c5c9),
